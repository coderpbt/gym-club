    ...
    <>
      <div className='lg:w-[20%] w-[30%] bg-black-rgba min-h-screen'>
        <div className='sticky top-0'>
            ...
            <a href='#' className='flex items-center bg-[#FF3030] rounded-xl p-2 justify-center text-white mx-2 mt-12'> <span className='mr-2'>Clear Cart </span><svg width="16" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href='#' className='flex items-center bg-[#FF9900] rounded-xl p-2 justify-center text-white mx-2 mt-3'><span className='mr-2'>Review Order</span> <svg width="16" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
